                ...
                <div className="main__news news">
                    <div className="container--lg">
                        ...
                        <div className="news__inner">
                            <div className="news__filter filter">

                                <div className="filter__vk filter__item">
                                    <a href="#">
                                        <svg width="70" height="70" xmlns="http://www.w3.org/2000/svg" aria-label="VK" role="img" viewBox="0 0 512 512">
                                ...
                                <div className="filter__instagram filter__item">
                                    <a href="#">
                                        <svg width="70" height="70" viewBox="0 0 3364.7 3364.7" xmlns="http://www.w3.org/2000/svg">
                                            <defs>
                                ...
                                <div className="filter__facebook filter__item">
                                    <a href="#">
                                        <svg className="filter__facebook-svg" width="70" height="70" viewBox="10 5 65 65">
                                            <path fill="#0059A5" d="M4.5 4.5H75.5V75.5H4.5z" />
                                            <path fill="#fff" d="M54,75V48h9.859l1.396-10H54v-6.768c0-3.135,1.403-5.272,5.899-5.272L66,25.958V16.45	c-0.992-0.132-4.762-0.427-8.722-0.427C49.01,16.023,44,21.069,44,30.337V38H34v10h10v27H54z" />
                                        </svg>
                                    </a>

                                </div>
                                <div className="filter__twitter filter__item">
                                    <a href="#">
                                        <svg width="70" height="70" xmlns="http://www.w3.org/2000/svg" aria-label="Twitter" role="img" viewBox="0 0 512 512">
